...
export default class AdbApiClient extends ApiBrokerClient {
  ...
  list(dbId: string, tableId: string, opts?: ListOpts): Promise<{ records: Record[]; }> {
    return this._rpc("list", [dbId, tableId, opts])
  }
